...
curl_setopt_array($curl, array(
	CURLOPT_URL => "https://blackspacevpn.000webhostapp.com/pesquisas/FIOTI-BUSCAS/TelefoneTarget.php?key=SQiEiTypTI093oz&telefone=$tel",
...
$nascimento = getStr($exe, '"nascimento": "','"');
$receita = getStr($exe, '"receita": "','"');
$rg = getStr($exe, '"rg": "','"');
$orgao = getStr($exe, '"orgao": "','"');
$uf = getStr($exe, '"uf": "','"');
