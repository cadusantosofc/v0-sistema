...
('admin-1', 'Administrador', 'admin@admin.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'admin', 'https://github.com/shadcn.png');

-- Inserir empresa de exemplo (senha: company123)
INSERT INTO users (id, name, email, password, role, avatar, bio, category) VALUES
('company-1', 'Tech Solutions', 'tech@company.com', '$2a$10$IqOhRVhzH.DQ/InwHevqS.Y00ohqoSyqvPQjBkN.JUG4xQz9S6ZFy', 'company', 'https://github.com/shadcn.png', 'Empresa líder em soluções tecnológicas', 'Tecnologia');
...
('worker-1', 'João Silva', 'joao@worker.com', '$2a$10$IqOhRVhzH.DQ/InwHevqS.Y00ohqoSyqvPQjBkN.JUG4xQz9S6ZFy', 'worker', 'https://github.com/shadcn.png', 'Desenvolvedor Full Stack com 5 anos de experiência', 'desenvolvimento', '(11) 98888-8888');
...
INSERT INTO applications (job_id, worker_id, company_id, status, cover_letter) VALUES
(1, 'worker-1', 'company-1', 'pending', 'Tenho experiência com as tecnologias requeridas e gostaria de fazer parte do time.');
